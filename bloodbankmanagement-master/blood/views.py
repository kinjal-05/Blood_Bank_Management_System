...
# Same for all three ways of logging in the crux is settings.py LOGIN_REDIRECT
...
def admin_dashboard_view(request):
    ...
    response = render(request, 'blood/admin_dashboard.html', context=dict)
...
def admin_blood_view(request):
    ...
    response = render(request, 'blood/admin_blood.html', context=dict)
    response['Cache-Control'] = 'no-cache, no-store, must-revalidate'  # HTTP 1.1.
    response['Pragma'] = 'no-cache'  # HTTP 1.0.
    response['Expires'] = '0'  # Proxies.
    return response
...
def admin_donor_view(request):
    ...
    response = render(request, 'blood/admin_donor.html', {'donors':donors})
    response['Cache-Control'] = 'no-cache, no-store, must-revalidate'  # HTTP 1.1.
    response['Pragma'] = 'no-cache'  # HTTP 1.0.
    response['Expires'] = '0'  # Proxies.
    return response
...
def admin_patient_view(request):
    ...
    response = render(request,'blood/admin_patient.html',{'patients':patients})
    response['Cache-Control'] = 'no-cache, no-store, must-revalidate'  # HTTP 1.1.
    response['Pragma'] = 'no-cache'  # HTTP 1.0.
    response['Expires'] = '0'  # Proxies.
    return response
...
def admin_request_view(request):
    ...
    response = render(request,'blood/admin_request.html',{'requests':requests})
    response['Cache-Control'] = 'no-cache, no-store, must-revalidate'  # HTTP 1.1.
    response['Pragma'] = 'no-cache'  # HTTP 1.0.
    response['Expires'] = '0'  # Proxies.
    return response
...
def admin_request_history_view(request):
    ...
    response = render(request, 'blood/admin_request_history.html', {'requests': requests})
    response['Cache-Control'] = 'no-cache, no-store, must-revalidate'  # HTTP 1.1.
    response['Pragma'] = 'no-cache'  # HTTP 1.0.
    response['Expires'] = '0'  # Proxies.
    return response
...
def admin_donation_view(request):
    ...
    response = render(request,'blood/admin_donation.html',{'donations':donations})
    response['Cache-Control'] = 'no-cache, no-store, must-revalidate'  # HTTP 1.1.
    response['Pragma'] = 'no-cache'  # HTTP 1.0.
    response['Expires'] = '0'  # Proxies.
    return response
